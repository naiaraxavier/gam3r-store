import NotaReview from "../shared/noteReview";
...
export const UserReviews = (props: UserReviewsProps) => {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-5 mt-5">
        <div className="flex flex-col gap-2 items-center">
          <div className="text-7xl text-pink-600">{props.product.note}</div>
          <NotaReview note={props.product.note} size={18} />
